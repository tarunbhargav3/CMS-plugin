...
final class smb_db
{
    ...
    public function __construct()
    {
        global $wpdb;
        $this->db = $wpdb;
        $this->table_settings = $this->db->prefix ."smb";
        $this->table_positionSettings = $this->db->prefix ."smb_position";
        $this->db_version = "1.2";
        $this->medias = include plugin_dir_path(__FILE__).'mediadata.php';
        $this->sqlErrorResponse =  __("Couldn't save settings. Data couldn't be updated.", 'smb');
        $this->successResponse =  __("Settings successfully saved!", 'smb');
    }
    ...
    public function create_table()
    {
        ...
        add_option('smb_db_version', $this->db_version);
        update_option('smb_db_version', $this->db_version);
    }
